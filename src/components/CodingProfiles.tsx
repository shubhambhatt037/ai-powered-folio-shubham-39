...
export function CodingProfiles() {
  const profiles = [{
    ...
    iconUrl: "/lovable-uploads/2b765b62-b452-4bfc-b2cc-600a18003da6.png",
    color: "text-blue-400",
    ...
    iconUrl: "/lovable-uploads/c69a4ecc-78c5-4b35-9f58-6656fee9e971.png",
    ...
    iconUrl: "/lovable-uploads/18c3a8e9-7499-4ec2-9214-b3b8c059c3f6.png",
